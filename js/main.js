...
(function ($) {
  ...
  var changeValue = function () {
    ...
    $(".item-checkk").click(function () {
      let shortText = $(this).find(".dom-value").text().trim(); // Get "WLB"
      let fullText = $(this).find(".dom-header-value").clone().children().remove().end().text().trim(); // Get "Wallet Balance" without the icon
  
      $(".dom-header").text(shortText); // Update .dom-header
      $(".dom-text").text(fullText); // Update .dom-text
    });

    $(".item-checkkk").click(function () {
      let shortText = $(this).find(".dom-valuee").text().trim(); // Get "WLB"
      let fullText = $(this).find(".dom-header-valuee").clone().children().remove().end().text().trim(); // Get "Wallet Balance" without the icon
  
      $(".dom-headerr").text(shortText); // Update .dom-header
      $(".dom-textt").text(fullText); // Update .dom-text
    });
